...
- AI Data Generation: Use @google/genai (Google GenAI SDK) to generate the pixelMap (16x16 array of color IDs), palette (color ID to HEX code mapping), and a short description of the generated dot matrix, in JSON format.
