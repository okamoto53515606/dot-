...
4.  **svgString**: 上記のpixelMapとpaletteを基に、プレビュー用のSVG文字列を生成してください。SVGの各ピクセルは10x10の<rect>要素で表現してください。viewBoxは "0 0 160 160" に設定し、<svg>要素には xmlns="http://www.w3.org/2000/svg" と style="image-rendering: pixelated;" を適用してください。
